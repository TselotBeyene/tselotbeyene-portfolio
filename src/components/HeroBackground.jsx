...
function HeroBackground() {
  return (
    <div className="absolute inset-0 z-0">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_68%_18%,var(--color-glow-primary),transparent_18%),radial-gradient(circle_at_63%_52%,var(--color-glow-secondary),transparent_25%)]" />
